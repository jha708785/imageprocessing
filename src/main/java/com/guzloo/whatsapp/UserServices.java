...
public class UserServices {
    ...
    public boolean saveUser(Userss user){
    ...
    private WatiResponse sendOtp(String phone, String otp) {
        RestTemplate rt = new RestTemplate();
        String apiUrl = watiTemplateMsgApiUrl + "?whatsappNumber=" + phone;
    ...
    public Userss validateOtp(String email, String otp){
        Userss user = userRepo.findByEmailAndOtp(email, otp);
        if(user!=null){
